...
- [x] [TASK-0017: prd 初回マイグレーション適用 + NFR-001 実測](TASK-0017.md) ✅ 完了 (2026-06-01)、3 migration prd 適用・NFR-001 約3秒・11テーブル/RLS/3RPC 確認。E は日次バックアップ機構の有効を確認（Free はスナップショット一覧/Restore 非提供→Pro 移行は実データ投入前の課題、recovery.md 反映）— 2-4h (DIRECT) 🔵
