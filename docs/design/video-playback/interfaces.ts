 ...
 * 関連要件: ../../spec/video-playback/requirements.md
 *
 * 信頼性レベル:
 * - 🔵 青信号: 要件定義書・設計文書・ADR・ユーザヒアリングを参考にした確実な型定義
 * - 🟡 黄信号: 妥当な推測による型定義
 * - 🔴 赤信号: 上記資料にない推測による型定義
 *
 ...
 * 🔵 REQ-104 / EDGE-101
 */
export declare function clampMs(ms: number, durationMs: number | null): number

// ========================================
// 信頼性レベルサマリー
// ========================================
/**
 * - 🔵 青信号: 大多数（要件 🔵 100% から導出。型はすべて requirements/ADR に接地）
 * - 🟡 黄信号: 1（PlayerEvent の集合は実装で確定する最小推測）
 * - 🔴 赤信号: 0
 *
 * 品質評価: 高品質
 */
